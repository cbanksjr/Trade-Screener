export const defaultUniverseName = "S&P 500 + Nasdaq 100";
...
const symbols = [
  ...
  "DAY", "DD", "DDOG", "DE", "DECK", "DELL", "DFS", "DG", "DGX", "DHI",
  ...
  "FFIV", "FI", "FICO", "FIS", "FITB", "FRT", "FOX", "FOXA", "FSLR", "FTNT",
  ...
  "MAR", "MAS", "MCD", "MCHP", "MCK", "MCO", "MDLZ", "MDT", "MELI", "META",
  "MET", "MGM", "MHK", "MKC", "MKTX", "MLM", "MMC", "MMM", "MNST", "MO",
  "MOH", "MOS", "MPC", "MPWR", "MRK", "MRNA", "MRVL", "MS", "MSCI", "MSFT",
  "MSI", "MTB", "MTCH", "MTD", "MU", "NDAQ", "NDSN", "NEE", "NEM", "NFLX",
  ...
  "TEL", "TER", "TFC", "TGT", "TJX", "TMO", "TMUS", "TPL", "TPR", "TRGP",
  "TRMB", "TROW", "TRV", "TSCO", "TSLA", "TSN", "TT", "TTWO", "TXN", "TXT",
  "TYL", "UAL", "UBER", "UDR", "UHS", "ULTA", "UNH", "UNP", "UPS", "URI",
  "USB", "V", "VEEV", "VICI", "VLO", "VLTO", "VMC", "VRSK", "VRSN", "VRTX",
  "VST", "VTR", "VTRS", "VZ", "WAB", "WAT", "WBA", "WBD", "WDAY", "WDC",
  "WEC", "WELL", "WFC", "WM", "WMB", "WMT", "WRB", "WSM", "WST", "WTW",
  "WY", "WYNN", "XEL", "XOM", "XYL", "YUM", "ZBH", "ZBRA", "ZTS", "ZS"
];

export const defaultUniverseSymbols = [...new Set(symbols)].sort();
